...
public class ListKelasActiveResponse {
    ...
    public ListKelasActiveResponse() {
    }

    public ListKelasActiveResponse(String status, ArrayList<KelasActive> listKelas, String errorMessage) {
        this.status = status;
